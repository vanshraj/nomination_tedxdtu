...
function debounce(func, wait, immediate) {
 ...
 $("#isNominee").click(function () {
      $('#nominee-firstname').attr("disabled", $(this).is(":checked"));
      $('#nominee-lastname').attr("disabled", $(this).is(":checked"));
      $('#nominee-email').attr("disabled", $(this).is(":checked"));
      $('#nominee-phone').attr("disabled", $(this).is(":checked"));
   });
